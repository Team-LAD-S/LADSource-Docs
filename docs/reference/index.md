...
**543 methods** were detected across **28 files**.
**119 methods** currently have descriptions.

| API group | Methods | Description |
| --- | ---: | --- |
| [LADBot modules](ladbot/index.md) | 526 | Methods inherited from `lad_framework_base`. |
