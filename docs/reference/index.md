...
**546 methods** were detected across **28 files**.
**121 methods** currently have descriptions.

| API group | Methods | Description |
| --- | ---: | --- |
| [LADBot modules](ladbot/index.md) | 529 | Methods inherited from `lad_framework_base`. |
