---
title: "ENT:HandleAnimEvent"
---

[Back to Events](index.md)

<a id="ent-handleanimevent"></a>
# `ENT:HandleAnimEvent` { .api-method-title }
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/events.lua:3751</code>.</p>
