...
```lua
function ENT:HandleDIRDuringAttack()
```
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/movement.lua:179</code>.</p>
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/movement.lua:16</code>.</p>
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/movement.lua:356</code>.</p>
