---
title: "ENT:GetRelativeDirection"
---

[Back to Moveset](index.md)

<a id="ent-getrelativedirection"></a>
# `ENT:GetRelativeDirection` { .api-method-title }
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/moveset.lua:156</code>.</p>
