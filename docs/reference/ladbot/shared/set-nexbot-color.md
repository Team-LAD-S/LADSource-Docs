...
Unimplemented/redundant, sets the color of the LADBot.
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/shared.lua:1675</code>.</p>
