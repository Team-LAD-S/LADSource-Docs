---
title: "ENT:CanForcePositionToNearestWall"
---

[Back to HACT](index.md)

<a id="ent-canforcepositiontonearestwall"></a>
# `ENT:CanForcePositionToNearestWall` { .api-method-title }
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/hact.lua:2424</code>.</p>
