---
title: "ENT:_HandleLandOnGround"
---

[Back to Overrides](index.md)

<a id="ent-handlelandonground"></a>
# `ENT:_HandleLandOnGround` { .api-method-title }
...
<p class="api-source">Defined in <code>lua/entities/lad_framework_base/overrides.lua:602</code>.</p>
